...
export default function DownloadAppCTA({
  ...
  return (
    ...
    >
      <div class="container !px-0 mx-auto max-w-7xl">
        <div class="flex flex-col items-center justify-center gap-3 lg:gap-5 text-center">
          ...
          <a 
            href={buttonLink}
            class="inline-block rounded-2xl transition-all hover:opacity-90 text-lg lg:text-xl"
            style={{ 
