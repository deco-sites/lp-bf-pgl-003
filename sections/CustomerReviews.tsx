...
export default function CustomerReviews({
  ...
  return (
    <section
      class="w-full py-12 lg:py-20 px-4 text-quicksand"
      style={{ backgroundColor }}
    >
      <div class="container mx-auto max-w-7xl">
        {/* Header */}
        <div class="text-center mb-12 lg:mb-16">
          <div class="flex flex-col lg:flex-row items-center justify-center gap-3 mb-1">
            {showIcon && (
            ...
            <h2 class="text-lg lg:text-3xl font-bold text-white font-sora">
              {title}
            </h2>
          </div>
            <p class="text-xl text-[#FCFCFC] font-light max-w-3xl mx-auto font-sora">
            {subtitle}
          </p>
        </div>
            ...
            >
              ...
              <div class="flex items-center gap-3">
                ...
                <div class="flex-1">
                  ...
                  <span
                    class="inline-flex items-center gap-1 rounded-full text-xs text-[#F5C2E6] mt-1 px-4"
                    style={{ backgroundColor: "#171A1E", border: "1px solid #FF009C" }}

                  >
                    <svg class="w-3 h-3" fill="#F5C2E6" viewBox="0 0 24 24">
              ...
              {/* Testimonial */}
              <p class="text-[#fff] text-xs leading-relaxed flex-1 text-quicksand">
                {review.testimonial}
              </p>
            </div>
          ))}
        ...
        <div class="text-center">
          <a
            href={ctaLink}
            class="inline-block px-8 lg:px-12 py-2 rounded-full text-white font-semibold text-base lg:text-xl transition-all hover:scale-105 hover:shadow-lg text-quicksand"
            style={{ backgroundColor: accentColor }}
          >
            {ctaText}
          </a>
