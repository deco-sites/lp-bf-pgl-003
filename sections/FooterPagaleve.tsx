...
export interface Props {
  ...
  /** @title Institucional (Desktop) */
  institutionalLinks?: Link[];
  
  /** @title Ajuda (Desktop) */
  helpLinks?: Link[];
  
  /** @title Parcerias e Políticas (Desktop) */
  ...
  return (
    <footer class="bg-black text-white py-12">
      <div class="container mx-auto px-4 lg:px-[52px]">
        ...
        {/* MOBILE LAYOUT */}
        <div class="lg:hidden">
          {/* Section 1: App Download (Mobile First) */}
          <div class="flex flex-col items-center gap-6 mb-12">
            <p class="font-quicksand text-sm font-normal text-white text-center">
              {appStoreTitle}
            </p>
          ...
          <div class="grid grid-cols-2 gap-x-8 gap-y-12 mb-12">
            ...
            {/* Column 3: Suporte (spans full width on next row) */}
          ...
          <div class="grid grid-cols-5 gap-12 mb-12">
            ...
            <div class="flex flex-col items-center gap-6">
              ...
              <div class="flex flex-col gap-4 w-full max-w-[202px]">
                ...
                >
                  <svg class="w-8 h-8" viewBox="0 0 35 38" fill="none">
                    <path d="M2.16 1.03c-.7.4-1.2 1.2-1.2 2.2v31.5c0 1 .5 1.8 1.2 2.2l.1.1 17.6-17.7v-.4L2.16 1.03z" fill="url(#a-desktop)"/>
                    <path d="M25.66 24.9l-5.9-5.9v-.4l5.9-5.9.1.1 7 4c2 1.1 2 3 0 4.2l-7 4-.1-.1z" fill="url(#b-desktop)"/>
                    <path d="M25.76 24.8l-6-6-17.6 17.6c.7.7 1.8.8 3 .1l20.6-11.7" fill="url(#c-desktop)"/>
                    <path d="M25.76 13.2L5.16 1.5c-1.2-.7-2.3-.6-3 .1l17.6 17.6 6-6z" fill="url(#d-desktop)"/>
                    <defs>
                      <linearGradient id="a-desktop" x1="19.9" y1="2.3" x2="6.1" y2="16.2" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#00A0FF"/>
                        <stop offset=".01" stop-color="#00A1FF"/>
                        <stop offset=".26" stop-color="#00BEFF"/>
                        <stop offset=".51" stop-color="#00D2FF"/>
                      ...
                      <linearGradient id="b-desktop" x1="34.9" y1="18.8" x2="1.6" y2="18.8" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FFE000"/>
                        <stop offset=".41" stop-color="#FFBD00"/>
                        <stop offset=".78" stop-color="#FFA500"/>
                        <stop offset="1" stop-color="#FF9C00"/>
                      </linearGradient>
                      <linearGradient id="c-desktop" x1="22.7" y1="21.6" x2="-.5" y2="44.8" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#FF3A44"/>
                        <stop offset="1" stop-color="#C31162"/>
                      </linearGradient>
                      <linearGradient id="d-desktop" x1="4.3" y1="-.9" x2="16.6" y2="11.4" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#32A071"/>
                        <stop offset=".07" stop-color="#2DA771"/>
                        <stop offset=".48" stop-color="#15CF74"/>
                        <stop offset=".8" stop-color="#06E775"/>
